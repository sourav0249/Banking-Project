...
public class l_accept_reject extends JFrame implements ActionListener,ItemListener
{
    Choice ch,ch8;
    ...
    l_accept_reject()
    {
        super("Accept/Reject Loan Request");
        setSize(210,500);
        setLocation(150,150);
        ch=new Choice();
        try
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        String u2=ae.getActionCommand();
         try
                {
                    String q="update loan set status='"+u2+"ed' where id='"+u1+"'";
                    conn c1=new conn();
                    c1.update(q);
                    if(u2.equals("Accept"))
                        JOptionPane.showMessageDialog(null, "Loan Request Accepted");
                    else
                        JOptionPane.showMessageDialog(null, "Loan Request Rejected");
                    dispose();
                }
                catch(Exception e){}
    }
