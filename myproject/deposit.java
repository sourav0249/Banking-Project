...
public class deposit extends JFrame implements ActionListener,ItemListener
{
    Choice ch;
    JLabel l1,l2,l3;
    JTextField t2,t3;
         ...
         try
                {
                    ...
                    String r = "insert into transaction values("+u1+",0,"+u3+",'"+d+"',"+(u2+u3)+")";
                    c1.update(r);
                    JOptionPane.showMessageDialog(null, "Amount Deposited and new balance = "+(u2+u3));
                    dispose();
                }
